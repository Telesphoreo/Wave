...
public class Config
{
    ...
    {
        configFile.put(configfile, new File(Bukkit.getServer().getPluginManager().getPlugin("Wave").getDataFolder(), configfile.getFile()));
        ...
        else
        {
            try
            {
                Bukkit.getServer().getPluginManager().getPlugin("Wave").getDataFolder().mkdir();
                InputStream jarURL = Wave.class.getResourceAsStream("/" + configfile.getFile());
